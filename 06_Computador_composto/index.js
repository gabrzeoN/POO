...
const VSCode = new Program("VSCode", 32, 3, () => console.log("You now are running VSCode."));
computer.install(VSCode);

const top = new Program("top", 1, 1, (computer) => { computer.storage.programs.forEach(program => program.running ? console.log(`---> ${program.name} is running`) : "") });
computer.install(top);
